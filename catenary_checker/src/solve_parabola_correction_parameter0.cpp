...
CorrectionParabolaParametersSolver::CorrectionParabolaParametersSolver(Grid3d* g_3D_, Grid3d* g_3D_obst_, Grid3d* g_3D_trav_, double d_tether_obs_, double l_tether_max_, int i_, geometry_msgs::Point plr_) 
{
